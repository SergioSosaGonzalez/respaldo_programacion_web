...
require 'C:\xampp\htdocs\programacion web\modelomvc\model\universitarios.php';
 ...
 */
  ...
  //carga html del buscador
       $buscador = $this->load_page('modelomvc/view/modules/buscador.php');
    ...
    //realiza consulta al modelo
     $tsArray = $universitario->universitarios($carrera,$cantidad);
      ...
      //carga la tabla de la seccion de VIEW
        include 'modelomvc/view/modules/table_univ.php';
      $table = ob_get_clean();
      //realiza el parseado 
 ...
 */
  ...
  $html = $this->load_page('modelomvc/view/modules/principal.php');
 ...
 */
  ...
  $html = $this->load_page('modelomvc/view/modules/historia.php');
  $pagina = $this->replace_content('/\#CONTENIDO\#/ms' ,$html , $pagina);
  $this->view_page($pagina);
   }
 ...
 */
 function load_template($title='Sin Titulo'){
  $pagina = $this->load_page('modelomvc/view/page.php');
  $header = $this->load_page('modelomvc/view/sections/header.php');
  $pagina = $this->replace_content('/\#HEADER\#/ms' ,$header , $pagina);
  $pagina = $this->replace_content('/\#TITLE\#/ms' ,$title , $pagina);
  $menu_left = $this->load_page('modelo mvc/view/sections/menuizquierda.php');
